...
-- Tiempo de generación: 04-05-2021 a las 20:12:19
...
ALTER TABLE `repairs`
  ...
  ADD KEY `fk_repairs_id` (`client_id`);
...
--
ALTER TABLE `offers`
  ADD CONSTRAINT `offers_ibfk_2` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`);
...
ALTER TABLE `repairs`
  ...
  ADD CONSTRAINT `fk_repairs_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
