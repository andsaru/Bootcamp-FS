...
export default function Shop() {
    ...
    return (
        <div>
            <ShoppingList category="electronics" products={shop.electronics}/>
            <ShoppingList category="groceries" products={shop.groceries}/>
            <ShoppingList category="pets" products={shop.pets}/>
        </div>
    )
}
